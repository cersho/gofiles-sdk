...
const RESOURCE_LINKS = [
  {
    external: true,
    href: "https://github.com/cersho/gofiles-sdk",
    label: "GitHub",
  },
  {
    external: true,
    href: "https://pkg.go.dev/github.com/cersho/gofiles-sdk",
    label: "pkg.go.dev",
  },
  {
    external: true,
    href: "https://github.com/cersho/gofiles-sdk/issues",
    label: "Issues",
  },
];
    ...
    <div className="mx-auto max-w-6xl px-6 py-14 sm:py-16">
      <div className="flex flex-col gap-10 sm:flex-row sm:justify-between sm:gap-16">
        <div className="flex max-w-[42ch] flex-col gap-2">
          ...
          <p className="text-base leading-relaxed text-pretty text-muted-foreground sm:text-sm">
            One storage client shape for Go services. Open source, MIT
            licensed.
          </p>
        </div>
      ...
      <div className="mt-12 flex flex-col gap-3 border-t border-dotted pt-6 sm:flex-row sm:items-center sm:justify-between">
        <p className="text-xs text-muted-foreground">
          &copy; {new Date().getFullYear()} Go Files SDK
        </p>
